            ...
            <div className="bg-[#EBE0D4]">
                ...
                <div className="flex flex-col items-center">
                    <div className='w-[900px] flex text-sm mb-4'>
                        <div className='bg-[url(./assets/listsimg5.png)] w-[200px] h-[70px] mt-3 bg-cover ml-10 mr-10'></div>
                    ...
                    <div className='w-[900px] flex text-sm mt-10 mb-4'>
                        <div className='bg-[url(./assets/listsimg2.png)] w-[215px] h-[75px] mt-2 bg-cover ml-8 mr-[40px]'></div>
                    ...
                    <div className='w-[900px] flex text-sm mt-8 mb-4'>
                        <div className='bg-[url(./assets/listsimg6.png)] w-[265px] h-[75px] bg-cover mr-[38px]'></div>
                        <div className='bg-[url(./assets/listsimg3.png)] w-[1px] h-[80px]'></div>
                    ...
                    <div className='w-[900px] flex text-sm mt-8 mb-4'>
                        <div className='bg-[url(./assets/listsimg7.png)] w-[220px] h-[80px] bg-cover ml-8 mr-10'></div>
                        <div className='bg-[url(./assets/listsimg3.png)] w-[2px] h-[80px]'></div>
