                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <div className="flex justify-between mb-6">
                                ...
                                <div>
                                    <p className="font-lato text-sm text-[#82774a] cursor-pointer hover:text-[#48453A] duration-300 ">
                            ...
                            <button
                                type="submit"
                                className="group relative flex w-full justify-center rounded-sm bg-[#48453A] px-3 py-2 text-sm font-light text-white hover:bg-[#5e5947] transition duration-300 font-lato mb-4"
                            >
                                Ingresar
                            </button>
                            <button
