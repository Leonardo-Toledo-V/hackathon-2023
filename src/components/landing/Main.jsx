...
export default function Main() {
    return (
        <div className='w-full'>
            ...
            <div>
                <div className='flex justify-start mt-24 xl:mt-44 lg:mt-32 md:mt-28 sm:mt-24'>
                    <div className='sm:w-[37rem] sm:h-[30rem]'>
                        <img className='hidden sm:block xl:w-full xl:h-full object-cover bg-top md:w-[450px] sm:w-[400px]' src="img2.png" alt="" />
                    </div>
                    <div className='flex flex-col ml-8 mr-8 xl:ml-24 xl:mt-12 lg:ml-16 md:mt-6 md:ml-14 sm:ml-8 sm:mt-8'>
                        <div>
                            <motion.h3
                                variants={fadeIn("down", 0.1)}
                                initial="hidden"
                                whileInView={"show"}
                                className="text-3xl xl:text-7xl text-[#ffffffca] uppercase font-inter lg:text-6xl md:text-5xl sm:text-3xl">Un chiapas<br /><span className='text-[#b71540]'>transparente</span></motion.h3>
                        </div>
                        <div className='mt-10 sm:flex sm:justify-between sm:items-center xl:mt-12 text-[#ffffffca] font-lato text-xl gap-8 lg:text-lg md:mr-3 sm:gap-6 sm:mt-10'>
                            <motion.p
                                ...
                                initial="hidden"
                                whileInView={"show"}
                                className='max-w-xs lg:w-[300px] md:w-[230px] sm:w-[170px] sm:text-base md:text-lg'>"Balam, en el lenguaje maya, lleva consigo un significado esencial “el jaguar”.
                            ...
                            <motion.p
                                ...
                                initial="hidden"
                                whileInView={"show"}
                                className='mt-14 max-w-xs lg:w-[300px] md:w-[230px] sm:w-[170px] sm:text-base'>Balam proporciona acceso a información detallada sobre las actividades del gobierno en Chiapas.<br />
            ...
            <div>
                <div className='flex justify-end mt-28 xl:mt-44 lg:mt-28 md:mt-24 sm:mt-20'>
                    <div className='flex flex-col ml-12 xl:ml-12 xl:mt-16 lg:mt-8 lg:mr-10 md:mt-6 md:mr-16 sm:mt-8 sm:mr-12'>
                        <motion.div
                            variants={fadeIn("up", 0.1)}
                            initial="hidden"
                            whileInView={"show"}>
                    ...
                    <div className='w-[45rem] h-[30rem]'>
                        <img className='object-cover w-full h-full lg:w-[400px] hidden sm:block' src="img3.png" alt="" />
                    </div>
                </div>
            </div>
            <div className='py-32'>
