            ...
            <div>
                <div className='flex justify-center xl:justify-start mt-24 xl:mt-44 lg:mt-32 md:mt-28 sm:mt-24'>
                    ...
                    <div className='flex flex-col w-full ml-8 xl:ml-24 xl:mt-12 lg:ml-16 md:mt-6 md:ml-14 sm:ml-8 sm:mt-8'>
                        ...
                        <div className='mt-10 sm:flex sm:justify-between sm:items-center xl:justify-start xl:mt-12 text-[#ffffffca] font-lato text-xl gap-8 lg:text-lg md:mr-3 sm:gap-6 sm:mt-10'>
                            <motion.p
                                variants={fadeIn("down", 0.1)}
                                initial="hidden"
                                whileInView={"show"}
